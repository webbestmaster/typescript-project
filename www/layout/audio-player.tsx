...
type LazyResultType<LazyComponentType> = {default: LazyComponentType};
...
const AudioLazy = lazy<ComponentType<AudioPropsType>>(
    async (): Promise<LazyResultType<ComponentType<AudioPropsType>>> => {
...
const PlayListProviderLazy = lazy<ComponentType<PlayListProviderPropsType>>(
    async (): Promise<LazyResultType<ComponentType<PlayListProviderPropsType>>> => {
...
const PlayListPanelLazy = lazy<ComponentType<unknown>>(async (): Promise<LazyResultType<ComponentType<unknown>>> => {
