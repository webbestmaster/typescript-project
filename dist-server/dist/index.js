...
*/
    ...
    /******/ (() => {
        /******/ __webpack_require__.h = () => '03455c19e8349f2f0ff4';
        /******/
    })();
    /******/
    ...
    (() => {
        ...
        const external_react_router_namespaceObject = require('react-router'); // CONCATENATED MODULE: external "react-router-dom"
        const external_react_router_dom_namespaceObject = require('react-router-dom'); // CONCATENATED MODULE: external "react-router-dom/server"
        const external_react_router_dom_server_namespaceObject = require('react-router-dom/server');
        // EXTERNAL MODULE: external "react-system-hook"
        var external_react_system_hook_ = __webpack_require__(882); // CONCATENATED MODULE: external "markdown-pro"
...
`;
            log(hiString);
            log('Build date:', '2021-11-09T19:55:03.392Z');
        ...
        }; // CONCATENATED MODULE: ./www/hook/url-hook-example/url-hook-helper.ts

        /* global URL */
        // eslint-disable-next-line complexity
        function stringifyUrlParameterSimpleValue(value) {
        ...
        function objectToUrlParameters(options) {
            const parameterList = [];
            // eslint-disable-next-line complexity
            Object.keys(options).forEach(key => {
                ...
                if (Array.isArray(value)) {
                    const stringList = value
                        .map(simpleValue => stringifyUrlParameterSimpleValue(simpleValue))
                        .filter(stringValueInner => Boolean(stringValueInner));
                    if (stringList.length > 0) {
                        parameterList.push(encodeURIComponent(key) + '=' + encodeURIComponent(stringList.join(',')));
                    }
                    return;
                }
                const stringValue = stringifyUrlParameterSimpleValue(value);
                if (stringValue) {
        ...
        function getParametersFromUrl(fullUrlString) {
            const url = new URL(fullUrlString);
            return Object.fromEntries(url.searchParams.entries());
        } // CONCATENATED MODULE: ./www/hook/url-hook-example/navigation-link.tsx
        ...
        function NavigationLink(props) {
            ...
            const resultQueries = isSaveQueries
                ? '' // {...currentQueries, ...passedQueries}
                : passedQueries;
            const queriesAsString = objectToUrlParameters(resultQueries);
            const queriesAsPartUrl = queriesAsString && `?${queriesAsString}`;
            return (0, jsx_runtime_.jsx)(
                external_react_router_dom_namespaceObject.Link,
                Object.assign({className: className, title: title, to: to + queriesAsPartUrl}, {children: children}),
                void 0
            );
        }
        ...
        function AppRouting() {
            const switchNode = (0, jsx_runtime_.jsxs)(
                external_react_router_namespaceObject.Routes,
                {
                    children: [
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_namespaceObject.Route,
                            {element: (0, jsx_runtime_.jsx)(Home, {}, void 0), path: appRoute.root.path},
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_namespaceObject.Route,
                            {element: (0, jsx_runtime_.jsx)(AsyncInfo, {}, void 0), path: appRoute.info.path},
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_namespaceObject.Route,
                            {element: (0, jsx_runtime_.jsx)(Error404, {}, void 0), path: '*'},
                            void 0
                        ),
                    ],
                },
            ...
            return isBrowser
                ...
                : (0, jsx_runtime_.jsx)(
                      external_react_router_dom_server_namespaceObject.StaticRouter,
                      Object.assign({location: '/'}, {children: switchNode}),
                      void 0
                  );
        ...
        console.warn(server_default().renderToString((0, jsx_runtime_.jsx)(App, {}, void 0)));
    })();
