...
var locale_context = __webpack_require__(935);
;// CONCATENATED MODULE: ./www/layout/error-data/error-data.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const error_data = ({"error_data":"f9913c","error_data__text":"a52e89"});
;// CONCATENATED MODULE: ./www/layout/error-data/error-data.tsx
...
function ErrorData(props) {
    ...
    return ((0,jsx_runtime_.jsx)("div", Object.assign({ className: (0,css/* classNames */.A)(error_data.error_data, className) }, { children: (0,jsx_runtime_.jsx)("p", Object.assign({ className: error_data.error_data__text }, { children: (0,jsx_runtime_.jsx)(locale_context/* Locale */.go, { stringKey: langKey }, void 0) }), void 0) }), void 0));
}
...
const external_react_localization_library_namespaceObject = require("react-localization-library");
;// CONCATENATED MODULE: ./www/provider/locale/translation/en-us/data.ts
const enUs = {
...
var locale_context_type = __webpack_require__(598);
;// CONCATENATED MODULE: ./www/provider/locale/locale-context-const.ts
...
const { LocalizationProvider, Locale, useLocale } = (0,external_react_localization_library_namespaceObject.createLocalization)(localizationConfig);
...
/******/ 			return "" + {"443":"load-me-async","672":"page-info"}[chunkId] + "." + __webpack_require__.h().slice(0, 6) + ".chunk.js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("8382cce6f62e5461ddc8")
/******/ 	})();
/******/ 	
...
// EXTERNAL MODULE: ./www/provider/locale/locale-context.ts + 7 modules
var locale_context = __webpack_require__(935);
;// CONCATENATED MODULE: ./www/component/app/app-provider.tsx



function AppProvider(props) {
    const { children } = props;
    return ((0,jsx_runtime_.jsx)(external_react_.StrictMode, { children: (0,jsx_runtime_.jsx)(locale_context/* LocalizationProvider */._C, { children: children }, void 0) }, void 0));
}
...
var external_react_router_dom_hook_ = __webpack_require__(59);
;// CONCATENATED MODULE: external "markdown-pro"
...
// EXTERNAL MODULE: ./www/util/css.ts
var css = __webpack_require__(643);
;// CONCATENATED MODULE: ./www/layout/spinner/spinner.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const spinner = ({"spinner_image":"c2a665","loading-spinner":"a278ac","spinner_wrapper":"c8fad8","ascii_spinner":"feccdd","ascii-spinner-animation":"eef587","show-spinner-animation":"e11de7"});
;// CONCATENATED MODULE: ./www/layout/spinner/spinner-const.ts
const defaultSpinnerSize = 48;

;// CONCATENATED MODULE: ./www/layout/spinner/spinner-type.ts
...
;// CONCATENATED MODULE: ./www/layout/spinner/spinner.tsx
...
function Spinner(props) {
    const { size = defaultSpinnerSize, lineWidth, arcColor, circleColor, isShow, wrapperWidth, wrapperHeight, position = SpinnerPositionEnum["static"], wrapperColor, wrapperPadding, className, } = props;
    if (isShow === false) {
        return null;
    }
    ...
    return ((0,jsx_runtime_.jsx)("div", Object.assign({ "aria-busy": "true", className: (0,css/* classNames */.A)(spinner.spinner_wrapper, className), style: spinnerWrapperStyle }, { children: (0,jsx_runtime_.jsx)("div", { className: spinner.spinner_image, style: spinnerImageStyle }, void 0) }), void 0));
}
...
// EXTERNAL MODULE: ./www/provider/locale/locale-context-type.ts
var locale_context_type = __webpack_require__(598);
;// CONCATENATED MODULE: ./www/util/format.ts
/* global Intl */
var TimeSizeEnum;
...
function useFormat() {
    ...
    const getFormattedNumberWrapper = (0,external_react_.useCallback)((value, options) => {
        return getFormattedNumber(localeName, value, options);
    }, [localeName]);
    const getFormattedDateTimeWrapper = (0,external_react_.useCallback)((date, options) => {
...
const getTestNodeData = isProduction
    ? productionGetTestNodeData
    : developmentGetTestNodeData;

;// CONCATENATED MODULE: ./www/library/library-component/library.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const library = ({"test_library":"e483b3","test_library__header":"f561fb"});
;// CONCATENATED MODULE: ./www/library/library-component/library-component.tsx


function LibraryComponent(props) {
    const { children, textContent } = props;
    return ((0,jsx_runtime_.jsxs)("div", Object.assign({ className: library.test_library }, { children: [(0,jsx_runtime_.jsx)("h3", Object.assign({ className: library.test_library__header }, { children: textContent }), void 0), (0,jsx_runtime_.jsx)("div", { children: children }, void 0)] }), void 0));
}

;// CONCATENATED MODULE: ./www/library/library.ts


;// CONCATENATED MODULE: ./www/layout/spinner/c-ascii-spinner.tsx
...
const external_react_audio_player_pro_namespaceObject = require("react-audio-player-pro");
;// CONCATENATED MODULE: ./www/const.ts
...
function ExamplePlayer() {
    return ((0,jsx_runtime_.jsxs)("div", Object.assign({ className: "example-wrapper" }, { children: [(0,jsx_runtime_.jsx)(Markdown, { config: { useWrapper: false }, mdInput: example_audio_player }, void 0), (0,jsx_runtime_.jsx)(external_react_audio_player_pro_namespaceObject.AudioPlayer, { defaultState: {
                    activeIndex: 0,
                    isMuted: false,
                    isShuffleOn: false,
                    isTrackListOpen: true,
                    repeatingState: 'none',
                }, trackList: audioDataList }, void 0), (0,jsx_runtime_.jsx)(external_react_audio_player_pro_namespaceObject.AudioPlayerControlSprite, {}, void 0)] }), void 0));
}
...
;// CONCATENATED MODULE: ./www/util/object.ts
...
;// CONCATENATED MODULE: ./www/layout/guard-suspense.tsx



function GuardSuspense(props) {
    const { children, fallback } = props;
    return isBrowser ? (0,jsx_runtime_.jsx)(external_react_.Suspense, Object.assign({ fallback: fallback }, { children: children }), void 0) : fallback;
}
...
var home = __webpack_require__(695);
;// CONCATENATED MODULE: ./www/page/home/home.tsx
...
const LoadMeAsync = (0,external_react_.lazy)(() => __webpack_require__.e(/* import() | load-me-async */ 443).then(__webpack_require__.bind(__webpack_require__, 389)));
...
function Home() {
    ...
    return ((0,jsx_runtime_.jsxs)("div", { children: [(0,jsx_runtime_.jsxs)("h1", Object.assign({ className: home/* default.home_header */.Z.home_header }, { children: ["home page (", (0,jsx_runtime_.jsx)(AsciiSpinner, {}, void 0), ")"] }), void 0), (0,jsx_runtime_.jsxs)("h4", { children: ["your ip is: ", myIp ? myIp.ip : (0,jsx_runtime_.jsx)(AsciiSpinner, {}, void 0)] }, void 0), (0,jsx_runtime_.jsx)("hr", {}, void 0), (0,jsx_runtime_.jsx)("button", Object.assign({ "data-test-data": getTestNodeData({ data: 'some-string' }), "data-test-id": getTestNodeId('language-button'), onClick: () => setLocaleName(localeName === locale_context_type/* LocaleNameEnum.enUs */.S.enUs ? locale_context_type/* LocaleNameEnum.ruRu */.S.ruRu : locale_context_type/* LocaleNameEnum.enUs */.S.enUs), type: "button" }, { children: localeName }), void 0), (0,jsx_runtime_.jsx)("hr", {}, void 0), (0,jsx_runtime_.jsx)(external_react_router_dom_hook_.NavigationLink, Object.assign({ to: app_route/* appRoute.info.path */.$.info.path }, { children: "to info" }), void 0), (0,jsx_runtime_.jsx)("hr", {}, void 0), (0,jsx_runtime_.jsx)("code", { children: getFormattedNumber(321, { style: 'unit', unit: 'liter', unitDisplay: 'long' }) }, void 0), (0,jsx_runtime_.jsx)("pre", { children: JSON.stringify(screenInfo, null, 4) }, void 0), (0,jsx_runtime_.jsx)(locale_context/* Locale */.go, { stringKey: "BUTTON__APPLY" }, void 0), (0,jsx_runtime_.jsx)("h4", { children: getLocalizedString('BUTTON__APPLY') }, void 0), (0,jsx_runtime_.jsx)("img", { alt: "", src: marker_icon_2x }, void 0), (0,jsx_runtime_.jsx)("img", { alt: "", src: questions_with_an_official_answer/* default */.Z }, void 0), (0,jsx_runtime_.jsx)(questions_with_an_official_answer/* ReactComponent */.r, {}, void 0), (0,jsx_runtime_.jsx)(GuardSuspense, Object.assign({ fallback: (0,jsx_runtime_.jsx)(Spinner, { position: "absolute" }, void 0) }, { children: (0,jsx_runtime_.jsx)(LoadMeAsync, { smth: "smth" }, void 0) }), void 0), (0,jsx_runtime_.jsx)(LibraryComponent, Object.assign({ textContent: "Hello, World" }, { children: (0,jsx_runtime_.jsx)("p", { children: "inner text" }, void 0) }), void 0), (0,jsx_runtime_.jsx)("hr", {}, void 0), (0,jsx_runtime_.jsx)(ExampleAudio, {}, void 0), (0,jsx_runtime_.jsx)(ExamplePlayer, {}, void 0)] }, void 0));
}
...
function AsyncInfo() {
    const AsyncInfoLazy = (0,external_react_.lazy)(() => __webpack_require__.e(/* import() | page-info */ 672).then(__webpack_require__.bind(__webpack_require__, 972)));
    return ((0,jsx_runtime_.jsx)(GuardSuspense, Object.assign({ fallback: (0,jsx_runtime_.jsx)(Spinner, { position: "absolute" }, void 0) }, { children: (0,jsx_runtime_.jsx)(AsyncInfoLazy, {}, void 0) }), void 0));
}
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const is_hidden = ({"is_hidden":"c55e81","is_hidden__hidden":"e1b7a2"});
;// CONCATENATED MODULE: ./www/layout/is-hidden/is-hidden.tsx



function IsHidden(props) {
    const { isHidden, children, className } = props;
    const fullClassName = (0,css/* classNames */.A)(is_hidden.is_hidden, { [is_hidden.is_hidden__hidden]: isHidden }, className);
    return (0,jsx_runtime_.jsx)("div", Object.assign({ className: fullClassName }, { children: children }), void 0);
}
...
/* harmony default export */ const empty = (__webpack_require__.p + "acf93e3.svg");

;// CONCATENATED MODULE: ./www/layout/empty/empty.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const empty_empty = ({"empty":"fcae9b","empty__image":"b64fa9","empty__header":"c41eb1","empty__text":"d585be"});
...
function Empty(props) {
    ...
    const mainTextNode = (0,external_react_.useMemo)(() => {
        ...
        return ((0,jsx_runtime_.jsx)("h4", Object.assign({ className: empty_empty.empty__header }, { children: (0,jsx_runtime_.jsx)(locale_context/* Locale */.go, { stringKey: mainText }, void 0) }), void 0));
    }, [mainText]);
    const secondaryTextNode = (0,external_react_.useMemo)(() => {
        if (!secondaryText) {
            return null;
        }
        return ((0,jsx_runtime_.jsx)("p", Object.assign({ className: empty_empty.empty__text }, { children: (0,jsx_runtime_.jsx)(locale_context/* Locale */.go, { stringKey: secondaryText }, void 0) }), void 0));
    }, [secondaryText]);
    return ((0,jsx_runtime_.jsxs)("div", Object.assign({ className: (0,css/* classNames */.A)(empty_empty.empty, className) }, { children: [(0,jsx_runtime_.jsx)("img", { alt: "", className: empty_empty.empty__image, src: empty }, void 0), mainTextNode, secondaryTextNode] }), void 0));
}
...
function Error404() {
    return ((0,jsx_runtime_.jsxs)("div", { children: [(0,jsx_runtime_.jsx)("h1", { children: "Page 404" }, void 0), (0,jsx_runtime_.jsx)(IsRender, Object.assign({ isRender: false }, { children: (0,jsx_runtime_.jsxs)(IsHidden, Object.assign({ isHidden: false }, { children: [(0,jsx_runtime_.jsx)(Empty, { mainText: "EMPTY__THERE_IS_NOTHING_HERE_YET", secondaryText: "EMPTY__TRY_CHANGING_FILTERS" }, void 0), (0,jsx_runtime_.jsx)(Spinner, { position: "static" }, void 0)] }), void 0) }), void 0)] }, void 0));
}
...
function AppRouting() {
    const switchNode = ((0,jsx_runtime_.jsxs)(external_react_router_dom_namespaceObject.Switch, { children: [(0,jsx_runtime_.jsx)(external_react_router_dom_namespaceObject.Route, { component: Home, exact: true, path: app_route/* appRoute.root.path */.$.root.path }, void 0), (0,jsx_runtime_.jsx)(external_react_router_dom_namespaceObject.Route, { component: AsyncInfo, exact: true, path: app_route/* appRoute.info.path */.$.info.path }, void 0), (0,jsx_runtime_.jsx)(external_react_router_dom_namespaceObject.Route, { component: Error404 }, void 0)] }, void 0));
    return isBrowser ? (0,jsx_runtime_.jsx)(external_react_router_dom_namespaceObject.BrowserRouter, { children: switchNode }, void 0) : (0,jsx_runtime_.jsx)(external_react_router_dom_namespaceObject.StaticRouter, { children: switchNode }, void 0);
}
...
function App() {
    return ((0,jsx_runtime_.jsx)(AppProvider, { children: (0,jsx_runtime_.jsx)(AppRouting, {}, void 0) }, void 0));
}
