/******/ (() => {
    ...
    /******/ (() => {
        ...
        /******/ __webpack_require__.u = chunkId => {
            ...
            /******/ return '' + 'load-me-async-lazy' + '.' + __webpack_require__.h().slice(0, 6) + '.chunk.js';
            /******/
        };
        /******/
    })();
    ...
    /******/ (() => {
        /******/ __webpack_require__.h = () => 'f1209a71a36f4d31298c';
        /******/
    })();
    /******/
    ...
    (() => {
        ...
        var jsx_runtime_ = __webpack_require__(997); // CONCATENATED MODULE: external "react"
        const external_react_namespaceObject = require('react'); // CONCATENATED MODULE: external "react-dom/server"
        const server_namespaceObject = require('react-dom/server');
        var server_default = /*#__PURE__*/ __webpack_require__.n(server_namespaceObject); // CONCATENATED MODULE: external "react-localization-library"
...
*/
        ...
        const zhTw = {
            ...
            /* eslint-enable id-match, id-length, max-len,sonarjs/no-duplicate-string, sort-keys */
        }; // CONCATENATED MODULE: ./www/provider/locale/locale-context-type.ts
        ...
        })(LocaleNameEnum || (LocaleNameEnum = {})); // CONCATENATED MODULE: ./www/provider/locale/locale-context-const.ts
...
*/
        ...
        const localizationConfig = {
            defaultLocaleName: getSavedLocaleName(Object.values(LocaleNameEnum)),
        ...
        external_react_localization_library_namespaceObject.createLocalization)(localizationConfig); // CONCATENATED MODULE: ./www/component/app/app-provider.tsx

        function AppProvider(props) {
            const {children} = props;
            return (0, jsx_runtime_.jsx)(
                external_react_namespaceObject.StrictMode,
                {children: (0, jsx_runtime_.jsx)(LocalizationProvider, {children: children}, void 0)},
                void 0
            );
        } // CONCATENATED MODULE: external "react-router-dom"

        const external_react_router_dom_namespaceObject = require('react-router-dom'); // CONCATENATED MODULE: external "react-system-hook"
        const external_react_system_hook_namespaceObject = require('react-system-hook'); // CONCATENATED MODULE: external "react-router-dom-hook"
        const external_react_router_dom_hook_namespaceObject = require('react-router-dom-hook'); // CONCATENATED MODULE: external "markdown-pro"
        const external_markdown_pro_namespaceObject = require('markdown-pro');
        var external_markdown_pro_default = /*#__PURE__*/ __webpack_require__.n(external_markdown_pro_namespaceObject); // CONCATENATED MODULE: ./www/util/css.ts
        // eslint-disable-next-line complexity
        ...
        function Spinner(props) {
            ...
            return (0, jsx_runtime_.jsx)(
                ...
                Object.assign(
                    {
                        'aria-busy': 'true',
                        className: classNames(spinner.spinner_wrapper, className),
        ...
        function ErrorData(props) {
            ...
            return (0, jsx_runtime_.jsx)(
                'div',
                Object.assign(
                    {className: classNames(error_data.error_data, className)},
                    {
                        children: (0, jsx_runtime_.jsx)(
                            'p',
                            Object.assign(
                                {className: error_data.error_data__text},
                                {children: (0, jsx_runtime_.jsx)(Locale, {stringKey: langKey}, void 0)}
                            ),
                            void 0
                        ),
                    }
        ...
        } // CONCATENATED MODULE: ./www/component/app/app-route.ts
        ...
        function useFormat() {
            ...
            const getFormattedNumberWrapper = (0, external_react_namespaceObject.useCallback)(
                (value, options) => {
                    return getFormattedNumber(localeName, value, options);
                },
                [localeName]
            );
            const getFormattedDateTimeWrapper = (0, external_react_namespaceObject.useCallback)(
                (date, options) => {
        ...
        function AsciiSpinner(props) {
            ...
            const wrapperClassName = classNames(spinner.ascii_spinner, className);
...
`;
            log(hiString);
            log('Build date:', '2021-10-31T15:12:02.693Z');
        ...
        function GuardSuspense(props) {
            ...
            return isBrowser
                ? (0, jsx_runtime_.jsx)(
                      external_react_namespaceObject.Suspense,
        ...
        var marker_icon_2x = __webpack_require__(436); // CONCATENATED MODULE: ./www/page/home/image/questions-with-an-official-answer.svg
        var _path;
        ...
        function SvgQuestionsWithAnOfficialAnswer(props) {
            return /*#__PURE__*/ external_react_namespaceObject.createElement(
                ...
                _path ||
                    (_path = /*#__PURE__*/ external_react_namespaceObject.createElement('path', {
        ...
        /* harmony default export */ const questions_with_an_official_answer = __webpack_require__.p + 'e2f0c34.svg'; // CONCATENATED MODULE: ./www/page/home/home.scss

        // extracted by mini-css-extract-plugin
        /* harmony default export */ const home = {'home_header': 'e4e05a'}; // CONCATENATED MODULE: ./www/page/home/home.tsx
        /* global setTimeout */
        ...
        const LoadMeAsyncLazy = (0, external_react_namespaceObject.lazy)(() =>
            __webpack_require__
                .e(/* import() | load-me-async-lazy */ 704)
                .then(__webpack_require__.bind(__webpack_require__, 832))
        );
        ...
        function Home() {
            ...
            const {screenInfo} = (0, external_react_system_hook_namespaceObject.useSystem)();
            const [isOpen, setIsOpen] = (0, external_react_namespaceObject.useState)(false);
            const [myIp, setMyIp] = (0, external_react_namespaceObject.useState)(null);
            setTimeout(() => {
                console.log(isOpen);
                setIsOpen(false);
            }, 1e3);
            ...
            return (0, jsx_runtime_.jsxs)(
                'div',
                {
                    children: [
                        ...
                        (0, jsx_runtime_.jsx)('hr', {}, void 0),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_hook_namespaceObject.NavigationLink,
                            Object.assign({to: appRoute.info.path}, {children: 'to info'}),
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)('hr', {}, void 0),
                        (0, jsx_runtime_.jsx)(
                        ...
                        (0, jsx_runtime_.jsx)(Locale, {stringKey: 'BUTTON__APPLY'}, void 0),
                        ...
                        (0, jsx_runtime_.jsx)('img', {alt: '', src: questions_with_an_official_answer}, void 0),
                        (0, jsx_runtime_.jsx)(SvgQuestionsWithAnOfficialAnswer, {}, void 0),
                        (0, jsx_runtime_.jsx)(
                            GuardSuspense,
                            Object.assign(
                                {fallback: (0, jsx_runtime_.jsx)(Spinner, {position: 'absolute'}, void 0)},
                                {children: (0, jsx_runtime_.jsx)(LoadMeAsyncLazy, {smth: 'smth'}, void 0)}
                            ),
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
        ...
        } // CONCATENATED MODULE: ./www/page/info/info.tsx
...
*/
        function Info() {
            ...
            } = (0, external_react_system_hook_namespaceObject.useSystem)();
            /*
    const {
...
*/
            ...
            } = (0, external_react_system_hook_namespaceObject.useScreenSize)();
            const screenWidth = (0, external_react_system_hook_namespaceObject.useScreenWidth)(); // number, default: 980
            const screenHeight = (0, external_react_system_hook_namespaceObject.useScreenHeight)(); // number, default: 768
            (0, external_react_namespaceObject.useEffect)(() => {
                console.log('info');
            });
            setTimeout(() => {
            ...
            return (0, jsx_runtime_.jsxs)(
                'div',
                {
                    children: [
                        (0, jsx_runtime_.jsx)(
                            'h1',
                            Object.assign({className: home.home_header}, {children: 'info page'}),
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_hook_namespaceObject.NavigationLink,
                            Object.assign({to: appRoute.root.path}, {children: 'to home'}),
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)('pre', {children: JSON.stringify(screenInfo, null, 4)}, void 0),
                        (0, jsx_runtime_.jsx)(
                        ...
                        (0, jsx_runtime_.jsx)('img', {alt: '', src: questions_with_an_official_answer}, void 0),
                        (0, jsx_runtime_.jsx)(SvgQuestionsWithAnOfficialAnswer, {}, void 0),
                        (0, jsx_runtime_.jsx)(Spinner, {position: 'absolute'}, void 0),
                    ],
                },
                void 0
            );
        ...
        function IsHidden(props) {
            ...
            const fullClassName = classNames(is_hidden.is_hidden, {[is_hidden.is_hidden__hidden]: isHidden}, className);
            return (0, jsx_runtime_.jsx)(
                'div',
        ...
        var empty_path, _path2, _path3;

        function empty_extends() {
            empty_extends =
                Object.assign ||
                function (target) {
                    for (var i = 1; i < arguments.length; i++) {
            ...
            return empty_extends.apply(this, arguments);
        }
        ...
        function SvgEmpty(props) {
            return /*#__PURE__*/ React.createElement(
                ...
                empty_path ||
                    (empty_path = /*#__PURE__*/ React.createElement('path', {
        ...
        function Empty(props) {
            ...
            const mainTextNode = (0, external_react_namespaceObject.useMemo)(() => {
                if (!mainText) {
                    return null;
                }
                return (0, jsx_runtime_.jsx)(
                    ...
                    Object.assign(
                        ...
                        {children: (0, jsx_runtime_.jsx)(Locale, {stringKey: mainText}, void 0)}
                    ),
                    void 0
                );
            }, [mainText]);
            const secondaryTextNode = (0, external_react_namespaceObject.useMemo)(() => {
                if (!secondaryText) {
                    return null;
                }
                return (0, jsx_runtime_.jsx)(
                    ...
                    Object.assign(
                        ...
                        {children: (0, jsx_runtime_.jsx)(Locale, {stringKey: secondaryText}, void 0)}
                    ),
                    void 0
                );
            }, [secondaryText]);
            return (0, jsx_runtime_.jsxs)(
                'div',
                Object.assign(
                    {className: classNames(empty_empty.empty, className)},
                    {
                        children: [
                            (0, jsx_runtime_.jsx)(
                                'img',
                ...
                external_react_router_dom_namespaceObject.Switch,
                {
                    children: [
                        (0, jsx_runtime_.jsx)(
                            ...
                            {component: Home, exact: true, path: appRoute.root.path},
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_namespaceObject.Route,
                            {component: Info, exact: true, path: appRoute.info.path},
                            void 0
                        ),
                        (0, jsx_runtime_.jsx)(
                            external_react_router_dom_namespaceObject.Route,
        ...
        console.warn('server');
        const htmlString = server_default().renderToStaticMarkup((0, jsx_runtime_.jsx)(App, {}, void 0));
        console.warn(server_default().renderToStaticMarkup((0, jsx_runtime_.jsx)(App, {}, void 0)));
        const hostname = '127.0.0.1';
        const port = 3000;
        const html =
            '<!DOCTYPE html><html lang="en"><head><meta name="format-detection" content="telephone=no"/><title>typescript app</title><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1"/><meta http-equiv="X-UA-Compatible" content="ie=edge"/><script defer="defer" src="/static/index.js?7d8a2acb280051c9b565"></script><link href="/static/style.css?7d8a2acb280051c9b565" rel="stylesheet"></head><body><div class="js-app-wrapper">{data}</div></body></html>';
